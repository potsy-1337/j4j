...
exports.run = (client, message, args) => {
    ...
    if (!message.member.roles.has("757283862660251808")) return message.channel.send("Bu Komutu Kullanmak İçin Gerekli Yetkiye Sahip Değilsin!")

let log = message.guild.channels.find(c => c.id === "757284399719907420") 
if (!log) return
    ...
    kullanici.addRoles("755084209554456647")
...
kullanici.removeRoles("755084209554456647")
    }, ms(süre))
}
